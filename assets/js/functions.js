$(document).ready(function () {
  var e = !0,
    i = null;
  $(this).on("mousewheel DOMMouseScroll", function (s) {
    if (!$(".outer-nav").hasClass("is-vis")) {
      s.preventDefault();
      var t = s.originalEvent.wheelDelta
        ? -s.originalEvent.wheelDelta
        : 20 * s.originalEvent.detail;
      t > 50 && e
        ? ((e = !1),
          clearTimeout(i),
  ...
  var s = document.getElementById("viewport"),
    t = new Hammer(s);
  function r(e) {
    var i = $(".side-nav").find(".is-active"),
      s = $(".side-nav").children().index(i),
      t = $(".side-nav").children().length - 1,
      r = 0;
    "swipeup" === e.type || 40 === e.keyCode || e > 0
      ? s !== t
        ? (l((r = s + 1)), a(s, r, t))
        : (l(r), a(s, r, t))
      : ("swipedown" === e.type || 38 === e.keyCode || e < 0) &&
        (0 !== s ? (l((r = s - 1)), a(s, r, t)) : (l((r = t)), a(s, r, t)));
  }
  function l(e) {
    $(".side-nav, .outer-nav").children().removeClass("is-active"),
      $(".side-nav").children().eq(e).addClass("is-active"),
      $(".outer-nav").children().eq(e).addClass("is-active");
  }
  function a(e, i, s) {
  ...
  t.get("swipe").set({ direction: Hammer.DIRECTION_VERTICAL }),
    ...
    $(".slider--prev, .slider--next").click(function () {
      var e = $(this),
        ...
        n = $(".slider--item-left"),
        m = $(".slider--item-center"),
        c = $(".slider--item-right"),
        o = $(".slider--item");
      $(".slider").animate({ opacity: 0 }, 400),
        setTimeout(function () {
          e.hasClass("slider--next")
            ? s < d - 1 && r < d - 1 && a < d - 1
              ? (n
